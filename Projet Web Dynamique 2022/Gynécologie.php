<?php
  ...
  $sql = "SELECT Nom,Prenom,Specialite FROM medecin where Specialite LIKE 'Gynecologue'";
...
<body>
  <div id="head" align="center" style="color:#5F9EA0;"><h1>Liste des Gynécologues</h1>
  </div>
 <div id="navi">
    <table>
       <thead>
